/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4e901c438c0685184f0760559683034c)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	VOTES_DB: D1Database;
	ASSETS: Fetcher;
	RESEND_EMAIL_FROM: "event@ymkw.top";
	ENTRY_FEED_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_EMAIL_FROM" | "ENTRY_FEED_URL" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "AUTH_SECRET" | "DISCORD_REDIRECT_URI" | "NEXT_PUBLIC_GA_ID">> {}
}
